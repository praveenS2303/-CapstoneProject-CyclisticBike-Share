...
#load original .csv files, a years worth of data from August 2021 to July 2022
...
cyclistic_date$time <- format(as.Date(cyclistic_date$date), "%H:%M:%S")  #create new column for time
cyclistic_date$time <- as_hms((cyclistic_df$started_at)) #format time as hh:mm:ss
...
#view and download the final data
View(cyclistic_date)
fwrite(cyclistic_date, file = 'cyclistic_date_df.csv')
#-----------------------------------------TOTAL RIDES--------------------------------------
